    ...
    <div class="p-10 min-h-screen flex items-center justify-center bg-black">
        ...
        <div class="h-96 w-96 relative">
            ...
            <div class="absolute inset-0 bg-gradient-to-tr from-cinza-escuro to-cinza-claro rounded-[30px]">
                ...
                <div class="flex flex-col mt-8 place-items-center">
                    ...
                    <div class="flex flex-row">
                        ...
                        <!-- grid place-items-center = para centralizar os items -->
                    ...
                    <span class="text-center mx-8 text-sm mt-6 text-white font-normal opacity-50">We appreciate you taking the time to give a rating. If you ever need more support, don't hesitate to get in touch!
                </div>
